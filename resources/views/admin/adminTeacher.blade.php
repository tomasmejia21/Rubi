                        ...
                        <tr>
                            ...
                            <td>
                                @if ($profesor->status)
                                    ...
                                    <form onsubmit="return confirmDelete()" action="{{ route('teachers.destroy', $profesor->teacherId) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                ...
                                @else
                                    ...
                                    <form onsubmit="return confirmActivate()" action="{{ route('teachers.activate', $profesor->teacherId) }}" method="POST" class="d-inline">
                                        @csrf
                                        <button type="submit" class="btn btn-hover-crimson">
