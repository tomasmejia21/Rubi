    ...
    <div class="container-fluid p-0 text-center">
        ...
        <div class="row">
            ...
            <div class="col" id="middleDiv">
                <form action="{{route('teachers.myinfoupdate',$teacher->teacherId)}}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="mb-3">
                        <label for="username" class="form-label">Usuario:
                            <input type="text" id="username" name="username" class="form-control" value="{{ $teacher->teacherUser }}" require disabled>
                        </label>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label">Correo:
                            <input type="email" id="email" name="email" class="form-control" value="{{ $teacher->email }}" data-current-email="{{ session('email') }}">
